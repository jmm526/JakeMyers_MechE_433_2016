...
#pragma config FPLLIDIV = DIV_2 // divide input clock to be in range 4-5MHz - Divide by 2 - 4MHz
#pragma config FPLLMUL = MUL_24 // multiply clock after FPLLIDIV - Multiply by 24 - 96 MHz
#pragma config FPLLODIV = DIV_2 // divide clock after FPLLMUL to get 48MHz - Divide by 2 - 48MHz
